...
export const VideoListComponentLevel = ({ mode }: VideoListProps) => {
  ...
  const getVideos = React.useCallback(async () => {
    try {
      ...
      const url = `/arbitrary/resources/search?mode=ALL&service=DOCUMENT&query=${QTUBE_VIDEO_BASE}_&limit=10&includemetadata=false&reverse=true&excludeblocked=true&name=${paramName}&exactmatchnames=true&offset=${offset}`
